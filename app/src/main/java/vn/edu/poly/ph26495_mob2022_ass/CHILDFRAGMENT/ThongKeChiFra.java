...
import vn.edu.poly.ph26495_mob2022_ass.OnboardingScreen;
import vn.edu.poly.ph26495_mob2022_ass.R;



public class ThongKeChiFra extends Fragment {
        ...
        img_thong_ke.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(tv_date_start.getText().toString().equals("")|| tv_date_finish.getText().toString().equals("")){
                    ...
                    int res = khoanChiDAO.selectCountKhoanChi(ngayBatDau,ngayKetThuc);
                    double res2 = khoanChiDAO.selectSumKhoanChi(ngayBatDau,ngayKetThuc);
    ...
    void anhXa(View view){
        date_start = view.findViewById(R.id.date_start_tk_chi);
        date_finish = view.findViewById(R.id.date_finish_tk_chi);
        tv_date_start = view.findViewById(R.id.tv_date_start_tk_chi);
        tv_date_finish = view.findViewById(R.id.tv_date_finish_tk_chi);
        ...
        tv_soLuong = view.findViewById(R.id.tv_soLuong_chi);
        tv_tongTien = view.findViewById(R.id.tv_tongTien_chi);
